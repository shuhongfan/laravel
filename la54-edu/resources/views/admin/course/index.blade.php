    ...
    <table class="table table-border table-bordered table-bg">
        ...
        @foreach($data as $val)
            <tr class="text-c">
                ...
                <td><img src="{{$val->cover_img}}" width="100" alt=""></td>
                <td>{{$val->sort}}</td>
                ...
                <td class="td-manage">
                    ...
                    @endif
                    <a title="编辑" href="javascript:;" onclick="admin_edit('课程编辑','admin-add.html','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
            </tr>
        @endforeach
        </tbody>
    </table>
