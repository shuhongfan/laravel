                        ...
                        <a style="cursor:pointer" href="/home/live/player?id={{$val->id}}" target="_blank">
                            ...
                            <div class="public-class-live-detail">
                                ...
                                <div class="detailLiveInfo clearfix">
                                    ...
                                    <div class="detailLiving"><img src="/home//home/img/zhiboNoStart.png" alt=""><span class="noStart">{{$val->liveStatus}}</span></div>
                                </div>
                            </div>
                        </a>
                    </li>
                        ...
                        <a href="/home/profession/detail?id={{$val->id}}" target="_blank">
                            ...
                            <div class="detail">
                                ...
                                <p class="info clearfix"><span><i>￥</i><span class="price">{{$val->price*0.0001}}</span>
                                        ...
                                        </span><span class="stuCount"><img src="/home//home/img/studentCount.png" alt=""><span class="studentCou">{{$val->view_count}}</span></span>
                                </p>
                            </div>
                        </a>
                    </div>
