    ...
    */
    ...
    'disks' => [
        ...
        'qiniu' => [
            'driver'  => 'qiniu',
            'domains' => [
                'default'   => 'qhmao65eu.hn-bkt.clouddn.com', //你的七牛域名
                'https'     => '',         //你的HTTPS域名
                'custom'    => '',                //Useless 没啥用，请直接使用上面的 default 项
            ],
            'access_key'=> 'YM3AdpV5Or317u5GqBPNBrdJjSPPw1jXFupiBAfc',  //AccessKey
            'secret_key'=> 'Bs8zedvgtqxSs8BtGj8Dl2Jrg2ejhPDZAa-xOIgX',  //SecretKey
            'bucket'    => 'shf',  //Bucket名字
